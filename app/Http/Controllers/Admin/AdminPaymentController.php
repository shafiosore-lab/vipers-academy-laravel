...
use App\Http\Requests\AdminPaymentFormRequest;
...
class AdminPaymentController extends Controller
{
     ...
     */
    public function store(AdminPaymentFormRequest $request)
    {
     ...
     */
    public function update(AdminPaymentFormRequest $request, Payment $payment)
    {
