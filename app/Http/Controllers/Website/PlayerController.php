...
class PlayerController extends \App\Http\Controllers\Controller
{
    ...
    public function index()
    {
        ...
        return view('website.players.index', compact('categories'));
    }
    ...
    public function overview($id)
    {
        ...
        return view('website.players.overview', compact('player', 'allPlayers'));
    }
    ...
    public function statistics($id)
    {
        ...
        return view('website.players.statistics', compact('player', 'allPlayers'));
    }
    ...
    public function aiInsights($id)
    {
        ...
        return view('website.players.ai-insights', compact('player'));
    }
