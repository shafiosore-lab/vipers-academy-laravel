                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('company_description') is-invalid @enderror"
                                          ...
                                          placeholder="{{ __('Brief description of the organization for website display...') }}">{{ old('company_description') }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('sponsorship_level') is-invalid @enderror"
                                    ...
                                    <option value="Platinum" {{ old('sponsorship_level') == 'Platinum' ? 'selected' : '' }}>{{ __('Platinum') }}</option>
                                    <option value="Gold" {{ old('sponsorship_level') == 'Gold' ? 'selected' : '' }}>{{ __('Gold') }}</option>
                                    <option value="Silver" {{ old('sponsorship_level') == 'Silver' ? 'selected' : '' }}>{{ __('Silver') }}</option>
                                    <option value="Bronze" {{ old('sponsorship_level') == 'Bronze' ? 'selected' : '' }}>{{ __('Bronze') }}</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('annual_contribution') is-invalid @enderror"
                                       id="annual_contribution" name="annual_contribution" value="{{ old('annual_contribution') }}"
