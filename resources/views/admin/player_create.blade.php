...
@section('title', 'FIFA Compliant Player Registration - Admin Dashboard')
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-0">FIFA Compliant Player Registration</h4>
                            <small class="opacity-75">Complete registration form for academy players</small>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('emergency_contact_relationship') is-invalid @enderror"
                                                           id="emergency_contact_relationship" name="emergency_contact_relationship" value="{{ old('emergency_contact_relationship') }}" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('father_id_number') is-invalid @enderror"
                                                           id="father_id_number" name="father_id_number" value="{{ old('father_id_number') }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('mother_id_number') is-invalid @enderror"
                                                           id="mother_id_number" name="mother_id_number" value="{{ old('mother_id_number') }}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('guardian_relationship') is-invalid @enderror"
                                                           id="guardian_relationship" name="guardian_relationship" value="{{ old('guardian_relationship') }}">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control @error('last_medical_checkup') is-invalid @enderror"
                                                           id="last_medical_checkup" name="last_medical_checkup" value="{{ old('last_medical_checkup') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('medical_conditions') is-invalid @enderror"
                                                      ...
                                                      placeholder="List any medical conditions, injuries, or health issues">{{ old('medical_conditions') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('allergies') is-invalid @enderror"
                                                      ...
                                                      placeholder="List any allergies (food, medication, environmental)">{{ old('allergies') }}</textarea>
                                            @error('allergies')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('medications') is-invalid @enderror"
                                                      ...
                                                      placeholder="List any medications currently being taken">{{ old('medications') }}</textarea>
                                            @error('medications')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('medical_insurance_provider') is-invalid @enderror"
                                                           id="medical_insurance_provider" name="medical_insurance_provider" value="{{ old('medical_insurance_provider') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('medical_insurance_number') is-invalid @enderror"
                                                           id="medical_insurance_number" name="medical_insurance_number" value="{{ old('medical_insurance_number') }}">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('height_cm') is-invalid @enderror"
                                                           id="height_cm" name="height_cm" value="{{ old('height_cm') }}" min="50" max="250" step="0.1">
                                                    @error('height_cm')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('weight_kg') is-invalid @enderror"
                                                           id="weight_kg" name="weight_kg" value="{{ old('weight_kg') }}" min="20" max="200" step="0.1">
                                                    @error('weight_kg')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('fifa_registration_number') is-invalid @enderror"
                                                           id="fifa_registration_number" name="fifa_registration_number" value="{{ old('fifa_registration_number') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('license_type') is-invalid @enderror" id="license_type" name="license_type">
                                                        ...
                                                        <option value="Semi-Professional" {{ old('license_type') == 'Semi-Professional' ? 'selected' : '' }}>Semi-Professional</option>
                                                        <option value="Professional" {{ old('license_type') == 'Professional' ? 'selected' : '' }}>Professional</option>
                                                        <option value="Youth" {{ old('license_type') == 'Youth' ? 'selected' : '' }}>Youth</option>
                                                    </select>
                                                    @error('license_type')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('transfer_status') is-invalid @enderror" id="transfer_status" name="transfer_status">
                                                        ...
                                                        <option value="Free Agent" {{ old('transfer_status') == 'Free Agent' ? 'selected' : '' }}>Free Agent</option>
                                                        <option value="Under Contract" {{ old('transfer_status') == 'Under Contract' ? 'selected' : '' }}>Under Contract</option>
                                                        <option value="Transfer Listed" {{ old('transfer_status') == 'Transfer Listed' ? 'selected' : '' }}>Transfer Listed</option>
                                                        <option value="Loan" {{ old('transfer_status') == 'Loan' ? 'selected' : '' }}>Loan</option>
                                                    </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('previous_clubs') is-invalid @enderror"
                                                      ...
                                                      placeholder="List previous clubs and years played">{{ old('previous_clubs') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('contract_status') is-invalid @enderror" id="contract_status" name="contract_status">
                                                ...
                                                <option value="Academy Contract" {{ old('contract_status') == 'Academy Contract' ? 'selected' : '' }}>Academy Contract</option>
                                                <option value="Youth Contract" {{ old('contract_status') == 'Youth Contract' ? 'selected' : '' }}>Youth Contract</option>
                                                <option value="Professional Contract" {{ old('contract_status') == 'Professional Contract' ? 'selected' : '' }}>Professional Contract</option>
                                                <option value="Trial Period" {{ old('contract_status') == 'Trial Period' ? 'selected' : '' }}>Trial Period</option>
                                            </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('school_grade') is-invalid @enderror"
                                                           id="school_grade" name="school_grade" value="{{ old('school_grade') }}" placeholder="e.g., Grade 8, Year 10">
                                                    @error('school_grade')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('academic_performance') is-invalid @enderror" id="academic_performance" name="academic_performance">
                                                ...
                                                <option value="Excellent" {{ old('academic_performance') == 'Excellent' ? 'selected' : '' }}>Excellent (A/A+)</option>
                                                <option value="Good" {{ old('academic_performance') == 'Good' ? 'selected' : '' }}>Good (B/B+)</option>
                                                <option value="Average" {{ old('academic_performance') == 'Average' ? 'selected' : '' }}>Average (C/C+)</option>
                                                <option value="Needs Improvement" {{ old('academic_performance') == 'Needs Improvement' ? 'selected' : '' }}>Needs Improvement (D/F)</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            <label for="academic_gpa" class="form-label">Academic GPA</label>
                                            <input type="number" step="0.01" min="0" max="4.0" class="form-control @error('academic_gpa') is-invalid @enderror"
                                                   id="academic_gpa" name="academic_gpa" value="{{ old('academic_gpa') }}" placeholder="e.g., 3.75">
                                            @error('academic_gpa')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="academic_notes" class="form-label">Academic Notes</label>
                                            <textarea class="form-control @error('academic_notes') is-invalid @enderror" id="academic_notes" name="academic_notes"
                                                      rows="3" placeholder="Additional academic information, achievements, or concerns">{{ old('academic_notes') }}</textarea>
                                            @error('academic_notes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('accommodation_provided') is-invalid @enderror" id="accommodation_provided" name="accommodation_provided" required>
                                                        ...
                                                        <option value="1" {{ old('accommodation_provided') == '1' ? 'selected' : '' }}>Yes</option>
                                                        <option value="0" {{ old('accommodation_provided') == '0' ? 'selected' : '' }}>No</option>
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('accommodation_details') is-invalid @enderror"
                                                              ...
                                                              placeholder="Describe accommodation arrangements if provided">{{ old('accommodation_details') }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('age_group') is-invalid @enderror" id="age_group" name="age_group">
                                                        ...
                                                        <option value="U-8" {{ old('age_group') == 'U-8' ? 'selected' : '' }}>U-8 (Under 8)</option>
                                                        <option value="U-9" {{ old('age_group') == 'U-9' ? 'selected' : '' }}>U-9 (Under 9)</option>
                                                        <option value="U-10" {{ old('age_group') == 'U-10' ? 'selected' : '' }}>U-10 (Under 10)</option>
                                                        <option value="U-11" {{ old('age_group') == 'U-11' ? 'selected' : '' }}>U-11 (Under 11)</option>
                                                        <option value="U-12" {{ old('age_group') == 'U-12' ? 'selected' : '' }}>U-12 (Under 12)</option>
                                                        <option value="U-13" {{ old('age_group') == 'U-13' ? 'selected' : '' }}>U-13 (Under 13)</option>
                                                        <option value="U-14" {{ old('age_group') == 'U-14' ? 'selected' : '' }}>U-14 (Under 14)</option>
                                                        <option value="U-15" {{ old('age_group') == 'U-15' ? 'selected' : '' }}>U-15 (Under 15)</option>
                                                        <option value="U-16" {{ old('age_group') == 'U-16' ? 'selected' : '' }}>U-16 (Under 16)</option>
                                                        <option value="U-17" {{ old('age_group') == 'U-17' ? 'selected' : '' }}>U-17 (Under 17)</option>
                                                        <option value="U-18" {{ old('age_group') == 'U-18' ? 'selected' : '' }}>U-18 (Under 18)</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('training_schedule') is-invalid @enderror"
                                                              ...
                                                              placeholder="e.g., Monday & Wednesday: 4-6 PM, Saturday: 9-11 AM">{{ old('training_schedule') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('competition_plan') is-invalid @enderror"
                                                      ...
                                                      placeholder="Describe planned competitions, tournaments, and match schedule">{{ old('competition_plan') }}</textarea>
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check mt-4">
                                                        <input class="form-check-input @error('safeguarding_policy_acknowledged') is-invalid @enderror"
                                                               type="checkbox" id="safeguarding_policy_acknowledged" name="safeguarding_policy_acknowledged" value="1" {{ old('safeguarding_policy_acknowledged') ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('previous_domicile') is-invalid @enderror"
                                                           id="previous_domicile" name="previous_domicile" value="{{ old('previous_domicile') }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('relocation_reason') is-invalid @enderror"
                                                              ...
                                                              placeholder="Reason for moving to current location">{{ old('relocation_reason') }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('registration_status') is-invalid @enderror" id="registration_status" name="registration_status" required>
                                                        <option value="Pending" {{ old('registration_status', 'Pending') == 'Pending' ? 'selected' : '' }}>Pending Review</option>
                                                        <option value="Approved" {{ old('registration_status') == 'Approved' ? 'selected' : '' }}>Approved</option>
                                                        <option value="Rejected" {{ old('registration_status') == 'Rejected' ? 'selected' : '' }}>Rejected</option>
...
function resetForm() {
    if (confirm('Are you sure you want to reset the form? All entered data will be lost.')) {
        ...
        document.getElementById('registrationProgress').style.width = '0%';

        // Reset to first tab
        const firstTab = document.querySelector('#playerTabs .nav-link');
