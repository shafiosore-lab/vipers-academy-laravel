...
@section('title', 'Create Program - Admin Dashboard')
                ...
                <div class="card-header bg-success text-white">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="opacity-75">Add a new training program to the academy</small>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('schedule') is-invalid @enderror"
                                              ...
                                              placeholder="e.g., Monday & Wednesday: 4-6 PM, Saturday: 9-11 AM">{{ old('schedule') }}</textarea>
                                    @error('schedule')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('mumias_discount_percentage') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('mumias_discount_percentage', 50) }}" min="0" max="100">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('mumias_fee') is-invalid @enderror"
                                                   id="mumias_fee" name="mumias_fee" value="{{ old('mumias_fee') }}" min="0" step="0.01">
                                            @error('mumias_fee')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            @error('image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="form-text">Optional: Upload a program image (JPG, PNG, GIF, max 2MB)</div>
                                        </div>
                                ...
                                <div class="card border-warning mt-3">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0"><i class="fas fa-clipboard-check me-2"></i>Program Checklist</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label small" for="confirmDetails">
                                                I confirm that all program details are accurate and complete
                                            </label>
                                        </div>
                                    </div>
                                </div>
