                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('fee_display') is-invalid @enderror"
                                                   id="fee_display" name="fee_display" value="{{ old('fee_display', $program->fee_display) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('schedule_display') is-invalid @enderror"
                                                   id="schedule_display" name="schedule_display" value="{{ old('schedule_display', $program->schedule_display) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('age_range') is-invalid @enderror"
                                                   id="age_range" name="age_range" value="{{ old('age_range', $program->age_range) }}"
