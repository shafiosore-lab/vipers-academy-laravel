...
@section('title', 'Add Website Player - Admin')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add New Player to Website</h3>
                    <a href="{{ route('admin.website-players.index') }}" class="btn btn-secondary float-right">
                        <i class="fas fa-arrow-left"></i> Back to Players
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.website-players.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('age') is-invalid @enderror"
                                           id="age" name="age" value="{{ old('age') }}" min="6" max="25" required>
                                    @error('age')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('jersey_number') is-invalid @enderror"
                                           id="jersey_number" name="jersey_number" value="{{ old('jersey_number') }}" min="1" max="99">
                                    @error('jersey_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Upload a JPG, PNG, or GIF image (max 5MB). Will be saved as: firstname-surname-category-position-age.jpg</small>
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('goals') is-invalid @enderror"
                                           id="goals" name="goals" value="{{ old('goals', 0) }}" min="0">
                                    @error('goals')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('appearances') is-invalid @enderror"
                                           id="appearances" name="appearances" value="{{ old('appearances', 0) }}" min="0">
                                    @error('appearances')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
