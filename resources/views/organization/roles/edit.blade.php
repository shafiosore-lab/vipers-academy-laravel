...
@section('title', __('Edit Organization Role'))

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>{{ __('Edit Organization Role') }}</h1>
    ...
    <form action="{{ route('organization.roles.update', $role->id) }}" method="POST" id="roleForm">
        @csrf
        @method('PUT')
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $role->slug) }}" readonly>
                            <small class="text-muted">{{ __('Cannot be changed after creation') }}</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="department" name="department" value="{{ old('department', $role->department) }}">
                        </div>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="inherit_permissions" name="inherit_permissions" value="1" {{ old('inherit_permissions', $role->inherit_permissions) ? 'checked' : '' }}>
