            ...
            <div class="card">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        @endphp
                        <a href="{{ $dashboardRoute }}" class="btn btn-light btn-sm">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-4 text-center">
                            ...
                            <span class="badge bg-primary">
                                @if(Auth::user()->hasRole('head-coach')){{ __('Head Coach') }}
                                    ...
                                    <div class="card border-0 bg-light h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-12"><strong>Role:</strong>
                                                    @if(Auth::user()->hasRole('head-coach')){{ __('Head Coach') }}
                                                    @elseif(Auth::user()->hasRole('coach')){{ __('Coach') }}
                                                    @elseif(Auth::user()->hasRole('assistant-coach')){{ __('Assistant Coach') }}
                                                    @elseif(Auth::user()->hasRole('team-manager')){{ __('Team Manager') }}
                                    ...
                                    <div class="activity-timeline">
                                        <div class="activity-item">
                                            ...
                                            <div class="activity-content">
                                                <h6 class="mb-1">Logged into staff panel</h6>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning">
                    <strong>Warning:</strong> This will also log you out and you will lose access to the staff panel.
                </div>
