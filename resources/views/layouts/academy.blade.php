...
<body>
            ...
            <ul class="nav-links">
                <li class="mega-parent">
                    ...
                    <div class="players-mega" id="players-mega-menu">
                        @php
                            $eligiblePlayers = \App\Models\Player::where('performance_rating', '>=', 8.5)->get();
                            $featuredPlayers = $eligiblePlayers->shuffle()->take(8);
                            $heroPlayer = \App\Models\Player::where('performance_rating', '>=', 9.0)->inRandomOrder()->first()
                                ?? $eligiblePlayers->shuffle()->first();
                        @endphp
                        @include('partials.premium-mega-menu', compact('featuredPlayers', 'heroPlayer'))
                    </div>
                </li>
                <li><a href="{{ route('programs') }}">Programs</a></li>
                <li><a href="{{ route('products.index') }}">Merchandise</a></li>
    ...
    <div class="mobile-menu" id="mobileMenu">
        <ul class="mobile-nav-links">
            ...
            <li><a href="{{ route('programs') }}">Programs</a></li>
            <li><a href="{{ route('eliteplayers') }}">Elite Players</a></li>
    ...
    <script>
        ...
        const megaMenu = document.querySelector('.players-mega');
        window.addEventListener('scroll', () => {
            ...
            if (megaMenu) {
                megaMenu.classList.toggle('shrink', currentScrollY > 10);
            }
